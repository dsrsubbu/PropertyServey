...
Ext.override(Ext.data.reader.Reader,
{
	...
	/*,getKeepRawData: function() {
		...
		alert(this.config.keepRawData);
		return data;
	}*/
});

/*var readerNew = new Ext.data.reader.Reader();
console.log(readerNew.getKeepRawData());
var reader = new Ext.data.reader.Json();
console.log(reader.getKeepRawData());*/
...
Ext.override(Ext.form.field.Base,
{
	getFieldLabel: function()
	{
		...
		return label = (label && this.allowBlank === false) ? label + IMS.mandatoryIndicator : label;;
	}
});
