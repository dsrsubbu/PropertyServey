 ...
 */
Ext.Date.defaultFormat = IMS.Date.Patterns.DefaultFormat;
Ext.Date.useStrict = true;
/**
 * Default Date Field Format.
 */
Ext.form.field.Date.prototype.format = IMS.Date.Patterns.DateFieldRendering;
Ext.form.field.Date.prototype.submitFormat = IMS.Date.Patterns.DateFieldSubmit;

/**
 * Default End Date
 */
//IMS.Date.DefaultEndDate = new Date('2099-12-31');

IMS.mandatoryIndicator = '<font style = "color:red; font-weight : bold; font-size:18px;"> *</font>';
//var IMS.editableFiedIndication = '<span style="font-size:9px;color:red;font-style:bold;bottom:3px;left:0px;position:relative;">#</span>';
IMS.msgConfig = {
...
Ext.define('Utils',
{
	statics:
	{
		...
		{
			Ext.MessageBox.show(IMS.msgConfig);
		}
		...
		{
			field.setValidation("Validating, Please Wait...");
