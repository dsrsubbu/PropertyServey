...
Ext.define('Ext.custom.window.Window',
{
	...
	,validateWinBeforeClose : function()
	{
		...
		{
			Utils.showAlert("Info", getLabel('FORM.DIRTY.CLOSE'), Ext.Msg.WARNING, Ext.Msg.YESNO, function(btn)
			{
				if (btn == 'yes')
				{
					me.close();
	...
	{
		var initialHeight = this.getInitialConfig('height') || this.getHeight();
