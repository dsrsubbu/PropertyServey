...
public class StringUtils
{
    ...
    public static String filterDuplicates(String tokenizedString, String delimiter)
    {
        ...
        LOG.info("filterd values :" + filteredStringValues);
    ...
    public static boolean containsToken(String commaSeperatedTokens, String token, String delimiter)
    {
        ...
        LOG.info("commaSeperatedTokens " + commaSeperatedTokens);
	...
	public static String encode2Base64(String value) 
    {
         return new String(Base64.encodeBase64(value.getBytes()));
    }

	public static String decode2Base64(String value) 
    {
         return new String(Base64.decodeBase64(value));
    }

	@SuppressWarnings("deprecation")
	public static Long getNextEscalationDate(Long tat) 
    {
		int nextDay = DateUtils.getFutureDayDate(1).getDay();
		int currentDay = DateUtils.getFutureDayDate(0).getDay();
		...
		{
			int dd = currentDay + tat.intValue();
			if (dd == 6l)
	    	{
	    		tat =   tat.intValue() + 2l;
	    	}
