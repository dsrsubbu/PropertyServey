...
public final class ImageUtils {
    ...
    public static String getMimeTypeFromBytes(byte[] bytes)
    {
        ...
        {
            LOG.info("Exception while getting mime type from bytes.");
            return null;
        }
    }

    public static String getExtensionFromBytes(byte[] bytes)
    {
        try
        {
            MagicMatch match = Magic.getMagicMatch(bytes);
        ...
        {
            LOG.info("Exception while getting extension from bytes.");
            return Constants.DEFAULT_IMG_EXT;
        }
    }
